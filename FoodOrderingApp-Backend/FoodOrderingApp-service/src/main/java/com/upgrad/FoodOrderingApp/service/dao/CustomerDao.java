...
public class CustomerDao {
    ...
    public CustomerEntity getCustomerByCustomerId(String custId){
        try{
            return entityManager.createNamedQuery("getCustomerById", CustomerEntity.class).setParameter("uuid", custId).getSingleResult();
        }catch (NoResultException nre) {
            return null;
        }
    }
