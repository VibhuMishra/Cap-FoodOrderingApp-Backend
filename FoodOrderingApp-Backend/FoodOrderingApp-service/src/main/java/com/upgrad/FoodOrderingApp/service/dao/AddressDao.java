...
public class AddressDao {
    ...
    public List<CustomerAddressEntity> getCustomerAddress(CustomerEntity customerId) {
        try {
            return entityManager.createNamedQuery("getCustomerAddress" , CustomerAddressEntity.class).setParameter("customerId" , customerId).getResultList();
        } catch (NullPointerException nre) {
            return null;
        }
    }
